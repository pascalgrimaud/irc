#
# Opless-Leaf.tcl par Ibu <ibu_lordaeron@yahoo.fr>
#
...
# .opless (en partyline)
#
# Ici, c le Opless-Leaf.tcl, tcl devant être chargé ds les Robots qui vont controler
# les salons Opless, et ensuite, envoyer à l'Hub les salons concernés
#
...
# Eggdrop qui sert de Hub
set Opless(hub) "LordAeron"
...
putlog "\002Opless-Leaf.tcl\002 par \002Ibu\002 14<ibu_lordaeron@yahoo.fr>"
...
# réception d'une requete d'opless
...
proc IsOpless { channel text } {
    ...
    putallbots "oplessnew \002Plus d'op sur $channel\002 ($text)"
    return
}
