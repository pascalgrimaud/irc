...
# putlog "\002OperInit-Lv2.tcl\002"
...
bind raw - "002" OperInitLv2

proc OperInitLv2 { from key text } {
    global botnick
    ...
    if { [string match "*Your host is irc.voila.fr*" $text]
      ...
      || [string match "*Your host is chat14.x-echo.com*" $text] } {
        ...
        raw "OPER [decrypt xxxx [lindex [split $temp] 0]] [decrypt xxxx [lindex [split $temp] 1]]"
        raw "MODE $botnick +a"
        unset temp
    }
    return 0
